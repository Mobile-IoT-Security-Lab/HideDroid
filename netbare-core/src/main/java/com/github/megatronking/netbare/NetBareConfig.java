...
public final class NetBareConfig {
    ...
    public static NetBareConfig defaultHttpConfigWithConnectivityManager(@NonNull JKS jks,
                                                  List<HttpInterceptorFactory> interceptors,
                                                                 ConnectivityManager connectivityManager) {
        return defaultConfig().newBuilder()
                .setVirtualGatewayFactory(new HttpVirtualGatewayFactory(jks, interceptors))
                .dumpUid(true) // add to print Uid process needed to detect app that generated specific traffic
    ...
    public static NetBareConfig defaultHttpConfigWithConnectivityManager(@NonNull JKS jks,
        ...
        return defaultConfig().newBuilder()
                ...
                .dumpUid(true) // add to print Uid process needed to detect app that generated specific traffic
                .setConnectivityManager(connectivityManager)
                .addAllowedApplication(allowedApps)
                .build();
    }
    ...
    public static class Builder {
        ...
        /**
         * Adds applications that's allowed to access the VPN connection.
         *
         * If this method is called at least once, only applications added through this method (and
         * no others) are allowed access. Else (if this method is never called), all applications
         * are allowed by default.  If some applications are added, other, un-added applications
         * will use networking as if the VPN wasn't running.
         *
         * @param listPackageName The list of package name (e.g.: "com.google.apps.contacts") of applications.
         * @return this {@link Builder} object to facilitate chaining method calls.
         */
        public Builder addAllowedApplication(@NonNull List<String> listPackageName) {
            mConfig.allowedApplications.addAll(listPackageName);
            return this;
        }
        ...
        public Builder setConnectivityManager(ConnectivityManager connectivityManager){
            mConfig.connectivityManager = connectivityManager;
            return this;
        }
        /**
